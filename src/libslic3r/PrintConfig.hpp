...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionBool,                seam_hide_at_interface))
    ((ConfigOptionFloat,               seam_interface_depth))
    ((ConfigOptionInt,                 seam_interface_skip_bottom_layers))
    ...
    ((ConfigOptionInt,                 flush_into_infill_min_layer))
